<div  id="sidebar-right">
	<?php if ( !dynamic_sidebar() ): ?>
		No hay widget para mostrar aun
	<?php endif;?>
	<div id="catcher"></div>
	<div class="widget suscription-box" id="suscription-box">
				...
				<form class="validate" name="mc-embedded-subscribe-form" method="post" action="http://paraisolinux.us2.list-manage1.com/subscribe/post?u=413970b102bb9578fa25fb925&amp;id=dbf2776ae9">
					<div class="info-suscription">
						<ul>
							...
							<li>Contenido y recomendaciones extra solo para suscriptores</li>
							<li>0 SPAM!</li>
						</ul>
					</div>
					<div>
						<input type="email" name="EMAIL" placeholder="Tu email aqui y luego Enter">
					</div>
				</form>
			</div>
		</div>
